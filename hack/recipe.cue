	...
	tags: [
		types.#Image & {
			registry: "push-registry.local"
 			image: "dubo-dubon-duponey/buildkit"
...
injector: {
	...
	// XXX all this is wrong
	_from_image: types.#Image & {#fromString: *"registry.local/dubo-dubon-duponey/debian:bullseye-2021-06-01" | string @tag(from_image, type=string)}
}
  ...
  image: scullery.#Cake & {
		recipe: {
			...
			metadata: {
				...
				title: "Dubo Buildkit",
				description: "A dubo image for Buildkit",
			}
		}
		icing: UserDefined
  }
